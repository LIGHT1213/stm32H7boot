...
extern touchgfx::GeneratedFont& getFont_STSONG_TTF_40_4bpp();
extern touchgfx::GeneratedFont& getFont_STSONG_TTF_10_4bpp();

const touchgfx::Font* touchgfx_fonts[] =
{
    &(getFont_STSONG_TTF_20_4bpp()),
    &(getFont_STSONG_TTF_40_4bpp()),
    &(getFont_STSONG_TTF_10_4bpp())
};
...
void resetFont(touchgfx::FontId fontId)
{
    ...
    {
    case 0:
        touchgfx_fonts[0] = &(getFont_STSONG_TTF_20_4bpp());
        break;
    case 1:
        touchgfx_fonts[1] = &(getFont_STSONG_TTF_40_4bpp());
        break;
    case 2:
        touchgfx_fonts[2] = &(getFont_STSONG_TTF_10_4bpp());
        break;
    }
}
}  // namespace TypedTextDatabase
